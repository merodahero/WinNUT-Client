...
#Region "Private Fields"
        ...
        Private _baseArcWidth As Integer = 5
        Private _needleColor1 As Color = Color.Red
        Private _needleColor2 As Color = Color.DimGray
        Private _needleRadius As Integer = 60
        Private _needleWidth As Integer = 2
        ...
        Private _scaleLinesMinorInnerRadius As Integer = 73
        Private _scaleLinesMinorOuterRadius As Integer = 80
        Private _scaleLinesMajorInnerRadius As Integer = 70
        Private _scaleLinesMajorOuterRadius As Integer = 80
        Private _scaleLinesInterInnerRadius As Integer = 70
        Private _scaleLinesInterOuterRadius As Integer = 80
